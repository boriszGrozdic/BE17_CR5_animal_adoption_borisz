...
<head>
    ...
    <style type="text/css">
        ...
        body {
            background-image: url("https://www.timeforkids.com/wp-content/uploads/2020/08/animalVoting.jpg?w=1024");
...
<body>
    <div style="margin-left: 10%; margin-top: 5%; height:40rem" class="container">
        <div class="row">
            <div class="col-2">
