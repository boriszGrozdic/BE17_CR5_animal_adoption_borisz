...
<body>
    <div class="container">
        <form style="margin-left: 10rem; margin-top:10rem;" class="w-75  shadow-lg p-3 mb-5 bg-body rounded" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
            <h2>Login</h2>
            <hr />
            <?php
            if (isset($errMSG)) {
