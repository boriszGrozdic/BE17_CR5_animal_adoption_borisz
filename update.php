    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>Phone number</th>
                    <td><input class="form-control" name="phone_number" placeholder="Phone number" value="<?php echo $phone_number ?>" /></td>
                </tr>
                <tr>
                    <th>Address</th>
                    <td><input class="form-control" name="address" placeholder="Address" value="<?php echo $address ?>" /></td>
                </tr>
                <tr>
                    <th>Picture</th>
